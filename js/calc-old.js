...
$('#advert-add-theme').on('click', () => {
    ...
    collectElem.innerHTML = '' +
        ...
        '<input type="text" class="advert-popup__filter" placeholder="Найти регион (мин. 3 символа)">' +
...
advPrice.on('click', (e) => {
    if (e.target.closest('.advert-ability') && e.target.closest('.advert-ability').querySelector('input') && !e.target.classList.contains('get-info') && e.target.closest('.advert-ability').dataset.need !== '1000') {
